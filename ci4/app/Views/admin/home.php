            ...
            <div class="col-sm-4 mb-3 mb-sm-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Silahkan cek surat masuk, apakah ada surat yang dikirim oleh client. Pastikan dengan mengecek secara teliti!</p>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Silahkan untuk membuat surat ke client, sebagai balasan dari surat yang telah dikirim. Lakukan pengisian surat secara teliti!</p>
